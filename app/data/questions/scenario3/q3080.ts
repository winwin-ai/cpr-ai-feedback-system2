...
export const q3080: Question = {
  id: 3080,
  scenarioId: 3,
  sessionId: 1,
  role: "Nurse 2",
  title: "구강기도유지기 삽입 (간호사2)",
  mediaType: "video",
  ...
  options: [
    ...
    {
      id: "2",
      text: "환자의 입술 끝에서 하악각까지의 길이로 구강기도유지기 사이즈를 선택하고, head tilt-chin lift 자세로 기도를 개방한 뒤 곡면을 위로 하여 삽입 후 180도 회전시켜 넣는다.",
    },
    {
      id: "3",
